...
## Debugging with breakpoints in VSCode

1. Install PHP Debug extension
2. Run "Listen for Xdebug"
3. Run "Launch currently open script"
4. Run "Launch Built-in web server"

update docker-compose to expose port 9003:9003 for the app
pecl install xdebug
docker-php-ext-enable xdebug
php --ini
service apache2 restart
set breakpoint and refresh browser to hit breakpoint inside endpoint
